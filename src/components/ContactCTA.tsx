    ...
    <section className="py-12 sm:py-16 md:py-24 bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-start max-w-6xl mx-auto">
          ...
          >
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold uppercase mb-4 sm:mb-6 leading-tight">
                Ready to Automate Your Success?
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-primary-foreground/90 font-body leading-relaxed">
          ...
          >
            <div className="bg-background text-foreground p-6 sm:p-8 border-2 border-primary-foreground/20">
              <div className="flex items-center gap-3 mb-6">
                <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                <h3 className="text-xl sm:text-2xl font-heading font-bold text-primary uppercase">
                  Quick Inquiry
                </h3>
              </div>
